...
def run():
    ...
    try:
        ...
        if len(py_files) > 0:
            ...
            # execute the code
            ssh.exec_command(f'cd {remote_current_working_directory};rm -rf log/* share/*')
...
if __name__ == '__main__':
    import os
    #os.system('rm -rf file_dict* share/vmb* log/*')
    run()
